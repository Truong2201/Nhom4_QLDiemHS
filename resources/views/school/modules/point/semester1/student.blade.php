        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> 1 </td>
                    <td text-align="center">Toán</td>
                    <td>{{ $semester1->madiem}}</td>
                    <td>{{ $semester1->diemcc}}</td>
                    <td>{{ $semester1->diemtx}}</td>
                    <td>{{ $semester1->diemgk}}</td>
                    <td>{{ $semester1->diemck}}</td>
                    <td>{{ $semester1->diemtong}}</td>
                    <td>{{ $semester1->diemrl}}</td>
                    <td>{{ $semester1->HeSodiemcc}}</td>
                    <td>{{ $semester1->HeSodiemtx}}</td>
                    <td>{{ $semester1->HeSodiemgk}}</td>
                    <td>{{ $semester1->HeSodiemck}}</td>
                </tr>
